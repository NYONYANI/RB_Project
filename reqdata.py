...
class RobotData:
    ...
    def unpack(self, data):
        ...
        offset += 24
        self.jnt_cur = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(6)]
        offset += 24
        self.tcp_ref = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(6)]
        offset += 24
        self.tcp_pos = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(6)]
        offset += 24
        self.analog_in = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(4)]
        offset += 16
        self.analog_out = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(4)]
        offset += 16
        self.digital_in = [struct.unpack('i', data[offset:offset+4])[0] for _ in range(16)]
        offset += 64
        self.digital_out = [struct.unpack('i', data[offset:offset+4])[0] for _ in range(16)]
        offset += 64
        self.jnt_temperature = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(6)]
        offset += 24
        ...
        offset += 4
        self.reserved_1 = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(6)]
        offset += 24
        self.jnt_info = [struct.unpack('i', data[offset:offset+4])[0] for _ in range(6)]
        offset += 24
        ...
        offset += 4
        self.tfb_analog_in = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(2)]
        offset += 8
        self.tfb_digital_in = [struct.unpack('i', data[offset:offset+4])[0] for _ in range(2)]
        offset += 8
        self.tfb_digital_out = [struct.unpack('i', data[offset:offset+4])[0] for _ in range(2)]
        offset += 8
        ...
        offset += 4
        self.inbox_trap_flag = [struct.unpack('i', data[offset:offset+4])[0] for _ in range(2)]
        offset += 8
        self.inbox_check_mode = [struct.unpack('i', data[offset:offset+4])[0] for _ in range(2)]
        offset += 8
        ...
        offset += 4
        self.extend_io1_analog_in = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(4)]
        offset += 16
        self.extend_io1_analog_out = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(4)]
        offset += 16
        self.extend_io1_digital_info, = struct.unpack('I', data[offset:offset+4])
        offset += 4
        self.aa_joint_ref = [struct.unpack('f', data[offset:offset+4])[0] for _ in range(6)]
        offset += 24
